...
# Figure 3.2: 1D Stability Analysis
...
plt.tick_params(labelsize=18)
plt.show()
plt.savefig('./Figures/Fig3_2b.png')
```
...
The first plot, figure 3.2c, will show $\delta = 0.01$. 
...
plt.savefig('./Figures/Fig3_2c.png')
```

## Figure 3.2d

In the same spirit as 3.2c, Figure 3.2d now uses all the same parameters but utilizes $\delta = 0.012$. Note the regions that now become stable. 
...
plt.savefig('./Figures/Fig3_2d.png')
```
