...
Planks = np.zeros((418,len(deltas)))
Chems = np.zeros((418,len(deltas)))
for k in range(len(deltas)):
    Swimmers = PM.PlankChem(depFcn=DM.constantDep,left=0,right=5,d1=2,d2=5,N=417,
                            dt=0.004,depMaxStr=0.01, depThreshold=0.24, depTransWidth=0.04, delta = deltas[k])
...
plt.legend(loc=1)
#plt.savefig('./Figures/Fig4_5b.png')
```
