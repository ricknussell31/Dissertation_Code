...
timesc = [0,4,20,100,150]

k = int(timesc[0]/Swimmers.dt)
lns1 = axs[0].plot(Swimmers.xm,PAC[k],color='r',label='Plankton',linewidth=2.5)
...
axs[1].set_title(r'$t = {0}$'.format(timesc[1]),fontsize=30)
...
axs[2].set_title(r'$t = {0}$'.format(timesc[2]),fontsize=30)
...
axs[3].set_title(r'$t = {0}$'.format(timesc[3]),fontsize=30)
...
axs[4].set_title(r'$t = {0}$'.format(timesc[4]),fontsize=30)
...
#input times you would like to plot
timesa = [0,4,20,100,150]

k = int(timesa[0]/Swimmers.dt)
lns1 = axs[0].plot(Swimmers.xm,PAS[k],color='r',label='Plankton',linewidth=2.5)
...
for i in range(0,5):
    ...
    axs[i].ticklabel_format(style='sci', scilimits=(2,2),axis='y')
    axs[i].ticklabel_format(style='plain',axis='x')
    axs[i].set_xlim(0,Swimmers.right)
    axs[i].set_title(r'$t = {0}$'.format(timesa[i]),fontsize=30)
    axs[i].yaxis.get_offset_text().set_fontsize(15)
...
#Input times you would like you plot

timesl = [0,4,20,75,100]

k = int(timesl[0]/Swimmers.dt)
lns1 = axs[0].plot(Swimmers.xm,PAL[k],color='r',label='Plankton',linewidth=2.5)
axs[0].ticklabel_format(style='sci', scilimits=(2,2),axis='y',useMathText=True)
axs[0].yaxis.get_offset_text().set_fontsize(16)
ax2 = axs[0].twinx()  #create a second axes that shares the same x-axis
...
axs[0].set_xlabel(r'$x$',fontsize=30)
axs[0].set_ylabel(r'Plankton Density', fontsize=22, color='r')
axs[0].set_title(r'$t = {0}$'.format(timesl[0]),fontsize=30)
axs[0].locator_params(nbins=5,axis='x')
axs[0].locator_params(nbins=4,axis='y')

axs[0].tick_params(labelsize=18)

k = int(timesl[1]/Swimmers.dt)
axs[1].plot(Swimmers.xm,PAL[k],color='r',linewidth=2.5)
axs[1].ticklabel_format(style='sci', scilimits=(2,2),axis='y')
axs[1].ticklabel_format(style='plain',axis='x')
axs[1].set_xlim(0,Swimmers.right)
axs[1].set_xlabel(r'$x$',fontsize=30)
axs[1].set_title(r'$t = {0}$'.format(timesl[1]),fontsize=30)
...
k = int(timesl[2]/Swimmers.dt)
axs[2].plot(Swimmers.xm,PAL[k],color='r',linewidth=2.5)
axs[2].ticklabel_format(style='sci', scilimits=(2,2),axis='y')
axs[2].ticklabel_format(style='plain',axis='x')
axs[2].set_xlim(0,Swimmers.right)
axs[2].set_xlabel(r'$x$',fontsize=30)
axs[2].set_title(r'$t = {0}$'.format(timesl[2]),fontsize=30)
...
k = int(timesl[3]/Swimmers.dt)
axs[3].plot(Swimmers.xm,PAL[k],color='r',linewidth=2.5)
axs[3].ticklabel_format(style='sci', scilimits=(2,2),axis='y')
axs[3].ticklabel_format(style='plain',axis='x')
axs[3].set_xlim(0,Swimmers.right)
axs[3].set_xlabel(r'$x$',fontsize=30)
axs[3].set_title(r'$t = {0}$'.format(timesl[3]),fontsize=30)
...
k = int(timesl[4]/Swimmers.dt)
axs[4].plot(Swimmers.xm,PAL[k],color='r',linewidth=2.5)
axs[4].ticklabel_format(style='sci', scilimits=(2,2),axis='y')
axs[4].ticklabel_format(style='plain',axis='x')
axs[4].set_xlim(0,Swimmers.right)
axs[4].set_xlabel(r'$x$',fontsize=30)
axs[4].set_title(r'$t = {0}$'.format(timesl[4]),fontsize=30)
...
times = np.linspace(0,400,len(Sums2))
